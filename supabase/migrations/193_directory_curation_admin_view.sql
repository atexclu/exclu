-- 193_directory_curation_admin_view.sql
--
-- Admin-side view for /admin/directory. Mirrors v_directory_creators but
-- relaxes the visibility/avatar constraints so the curation page can show
-- the full creator base (including Pro accounts hidden globally or without
-- avatars). Adds total_earned_cents for the "best sellers" sort.
