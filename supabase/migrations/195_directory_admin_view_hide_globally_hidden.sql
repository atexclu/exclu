-- 195_directory_admin_view_hide_globally_hidden.sql
--
-- Globally-hidden creators (is_directory_visible = false) shouldn't show up in
-- /admin/directory either: the admin already made the decision elsewhere
-- (User overview), surfacing them in the curation feed is just noise.
