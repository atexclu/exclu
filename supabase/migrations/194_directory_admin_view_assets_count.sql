-- 194_directory_admin_view_assets_count.sql
--
-- Extend v_directory_creators_admin with assets_count (live, non-deleted)
-- so the curation cards can surface a "contenus" stat alongside views,
-- paid links and earnings.
